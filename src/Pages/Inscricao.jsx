        ...
        <div>
            ...
            <div>
                ...
                <div className="flex flex-col justify-center items-center m-2 p-0">
                    ...
                    <p className="text-center text-sm">Vem aí a primeira COPA PERNAMBUCO DE ATLETISMO MASTER, <br/> não fique de fora. Faça sua inscrição e participe desse <br /> grande evento que conta com a realização da AAPD e ajni eventos.</p>
