        ...
        <div>
            ...
            <div>
                ...
                <div className="flex flex-col justify-center items-center m-2 p-0">
                    ...
                    <p className="text-center text-sm">A primeira COPA PERNAMBUCO DE ATLETISMO MASTER <br /> vem aí, não fique de fora. Faça sua inscrição e participe desse <br /> grande evento que conta com a realização da ajni eventos.</p>
                    <p className="text-center font-bold text-sm sm:text-md m-2 ">LEIA ATENTAMENTE O REGULAMENTO ANTES <br /> DE FAZER A INSCRICAO, APÓS LER <br /> O REGULAMENTO ENTRE NA OPÇÃO DE INSCRIÇÃO <br /> NO TOPO DESTA PÁGINA E FAÇA A MESMA.</p>
                </div>
            </div>
        </div>
    )
